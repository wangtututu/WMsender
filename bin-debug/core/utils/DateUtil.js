...
var DateUtil = (function () {
     ...
     *
     */
    DateUtil.prototype.getFormatBySecond = function (second, type) {
    ...
    //1: 00:00:00
    DateUtil.prototype.getFormatBySecond1 = function (t) {
        if (t === void 0) { t = 0; }
    ...
    DateUtil.prototype.getFormatBySecond6 = function (t) {
        var hourst = Math.floor(t / 3600);
        var minst = Math.floor((t - hourst * 3600) / 60);
        return hourst + Api.GlobalRes.getText("hour") + minst + Api.GlobalRes.getText("minute");
    };
    //3: 00:00
    DateUtil.prototype.getFormatBySecond3 = function (t) {
        if (t === void 0) { t = 0; }
        var hourst = Math.floor(t / 3600);
        var minst = Math.floor((t - hourst * 3600) / 60);
        var secondt = Math.floor((t - hourst * 3600) % 60);
    ...
    //2:yyyy-mm-dd h:m:s
    DateUtil.prototype.getFormatBySecond2 = function (time) {
    ...
    //4:xx天前，xx小时前，xx分钟前
    DateUtil.prototype.getFormatBySecond4 = function (time) {
    ...
    DateUtil.prototype.getFormatBySecond5 = function (time) {
        //每个时间单位所对应的秒数
        var oneDay = 3600 * 24;
        var oneHourst = 3600;
        var oneMinst = 60;
    ...
    DateUtil.prototype.getTimeInfo = function () {
        var date = new Date();
